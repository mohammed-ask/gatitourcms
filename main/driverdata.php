...
while ($row = $obj->fetch_assoc($result)) {
    ...
    $n[] = "<a target='_blank' href='https://www.google.com/search?q=" . $row['lat'] . "+" . $row['long'] . "'> Latitude : " . $row['lat'] . " Longitude : " . $row['long']. " on " . changedateformatespecito($row['lastupdate'], "Y-m-d H:i:s", "d/m/Y h:i a") . "<a>";
    $a = "";

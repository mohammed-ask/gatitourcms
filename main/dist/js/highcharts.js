...
// encapsulated variables
    ...
    function error(code, stop) {
        var msg = 'Abaxsoft error #' + code + ': www.abaxsoft.com' + code;
        if (stop) {
            throw new Error(msg);
        }
        // else ...
...
//            tickPositions.push(time);
if(time!=max){
var num123=tickPositions.length;
delete tickPositions[num123-1];
tickPositions.push(max);
    ...
    */
    ...
    /**
     *  module to hide overlapping data labels. This module is included in .
     */
    (function (H) {
        var Chart = H.Chart,
            each = H.each,
    ...
    extend(Series.prototype, {
        ...
        /**
         * Set the selected state of the graphend
         *
